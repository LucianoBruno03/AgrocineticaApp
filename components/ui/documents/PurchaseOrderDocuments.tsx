...
import PurchaseOrderFilesList from "../lists/PurchaseOrderFilesList";
...
const PurchaseOrderDocuments = ({ idPurchaseOrder }: Props) => {
  ...
  return (
    ...
    >
      ...
      <PurchaseOrderFilesList idPurchaseOrder={idPurchaseOrder} />
    </View>
  );
};
